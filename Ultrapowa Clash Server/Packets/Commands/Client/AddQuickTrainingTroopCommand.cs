...
namespace UCS.PacketProcessing.Commands.Client
{
    internal class AddQuicKTrainingTroopCommand : Command
    {
        ...
        public List<AddQuicKTrainingTroopCommand.UnitToAdd> UnitsToAdd { get; set; }
        ...
        public AddQuicKTrainingTroopCommand(PacketReader br)
        {
            ...
            for (int i = 0; i < TroopType; i++)
              UnitsToAdd.Add(new AddQuicKTrainingTroopCommand.UnitToAdd()
              {
                Data = (CharacterData)br.ReadDataReference(),
                Count = br.ReadInt32()
              });
            Tick = br.ReadInt32();
        }
