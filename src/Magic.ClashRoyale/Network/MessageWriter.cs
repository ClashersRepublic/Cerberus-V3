...
namespace Magic.Network
{
    ...
    public class MessageWriter : BinaryWriter
    {
        ...
        public void Write(int value, bool rrint)
        {
            if (rrint)
            {
                // TODO: Implement own.
        ...
        /// </summary>
        /// <param name="value">The string to write.</param>
        /// <param name="zlib">Whether the string is Zlib compressed.</param>
        /// <exception cref="ObjectDisposedException">The <see cref="MessageWriter"/> is closed.</exception>
        public void Write(string value, bool zlib)
        {
            CheckDispose();
            ...
            else
            {
                ...
                if (zlib)
                {
                    var compressedBytes = ZlibStream.CompressBuffer(buffer);

                    // Write prefix.
                    Write(compressedBytes.Length + sizeof(int));
                    // Write length of uncompressed data in little endian.
