...
namespace CR.Servers.Core.Consoles.Colorful
{
    ...
    public sealed class ColorMapper
    {
        ...
        /// </summary>
        /// <param name="colors">
        ///     A dictionary containing COLORREFs keyed by the COLORREF's alias in the buffer's
        ///     ColorTable.
        /// </param>
        ...
        private struct CONSOLE_SCREEN_BUFFER_INFO_EX
        {
            ...
            internal readonly ushort wAttributes;
            internal SMALL_RECT srWindow;
            internal readonly COORD dwMaximumWindowSize;
            internal readonly ushort wPopupAttributes;
            internal readonly bool bFullscreenSupported;
