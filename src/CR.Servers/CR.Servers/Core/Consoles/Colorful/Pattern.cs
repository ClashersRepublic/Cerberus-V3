...
namespace CR.Servers.Core.Consoles.Colorful
{
    ...
    public abstract class Pattern<T> : IEquatable<Pattern<T>>
    {
        ...
        /// <returns>
        ///     Returns a collection of the locations in the object under comparison that
        ///     match the Pattern instance.
        /// </returns>
        ...
        /// <param name="input">The object to which the Pattern instance should be compared.</param>
        /// <returns>
        ///     Returns a collection of tokens in the object under comparison that
        ///     match the Pattern instance.
        /// </returns>
