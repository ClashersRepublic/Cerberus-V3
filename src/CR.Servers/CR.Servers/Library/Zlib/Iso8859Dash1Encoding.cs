namespace CR.Servers.Library.ZLib
{
    ...
    public class Iso8859Dash1Encoding : System.Text.Encoding
    {
        ...
        public override int GetBytes(char[] chars, int start, int count, byte[] bytes, int byteIndex)
        {
            ...
            // iso-8859-1 is special in that it was adopted as the first page of UCS - ISO's
            // Universal Coding Standard, described in ISO 10646, which is the same as Unicode. This
            // means that a a Unicode character in the range of 0 to FF maps to the iso-8859-1
            // character with the same value. Because of that the encoding and decoding is trivial.
