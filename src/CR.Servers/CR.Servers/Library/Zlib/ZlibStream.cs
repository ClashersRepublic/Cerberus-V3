namespace CR.Servers.Library.ZLib
{
    ...
    /// <remarks>
    /// <para>
    /// The ZlibStream is a <see href="http://en.wikipedia.org/wiki/Decorator_pattern"> Decorator
    /// </see> on a <see cref="System.IO.Stream"/> . It adds ZLIB compression or decompression to any stream.
    /// </para>
    /// <para>
    ...
    /// reading or writing. The compression format used is ZLIB, which is documented in <see
    /// href="http://www.ietf.org/rfc/rfc1950.txt"> IETF RFC 1950 </see> , "ZLIB Compressed Data
    /// Format Specification version 3.3". This implementation of ZLIB always uses DEFLATE as the
    /// compression method. (see <see href="http://www.ietf.org/rfc/rfc1951.txt"> IETF RFC 1951
    /// </see> , "DEFLATE Compressed Data Format Specification version 1.3.")
    /// </para>
    /// <para>
    ...
    public class ZlibStream : Stream
    {
        ...
        public static byte[] CompressBuffer(byte[] b)
        {
            ...
            {
                using (Stream compressor = new ZlibStream(ms, CompressionMode.Compress, CompressionLevel.Default))
                {
