namespace Magic.Network.Cryptography.NaCl.Internal
{
    internal static class salsa20
    {
        private const int crypto_core_salsa20_ref_OUTPUTBYTES = 64;
        private const int crypto_core_salsa20_ref_INPUTBYTES = 16;
        private const int crypto_core_salsa20_ref_KEYBYTES = 32;
        private const int crypto_core_salsa20_ref_CONSTBYTES = 16;
        private const int crypto_stream_salsa20_ref_KEYBYTES = 32;
        private const int crypto_stream_salsa20_ref_NONCEBYTES = 8;

        private const int ROUNDS = 20;

        private static int rotate(int u, int c)
        {
