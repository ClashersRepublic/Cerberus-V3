...
namespace Magic.Logic.StreamEntry
{
    internal class StreamEntry
    {
        private int m_vType = -1;
        public int m_vState = 1;
        public System.Collections.Generic.List<DonationSlot> m_vUnitDonation;
        public System.Collections.Generic.List<BookmarkSlot> m_vDonatorList;
        ...
        public int m_vDonatedTroop;
        public int m_vDonatedSpell;
        ...
        public void AddUsedCapicity(int amount)
        {
            this.m_vDonatedTroop = m_vDonatedTroop + amount;
        }
    }
}
