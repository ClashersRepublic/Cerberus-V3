...
namespace Magic.Network
{
    ...
    public static class MessageFactory
    {
        ...
        /// </returns>
        public static Message Create(ushort messageId)
        {
            var type = (Type)null;
            if (!s_messageDictionary.TryGetValue(messageId, out type))
                return new UnknownMessage() { Id = messageId };
        ...
        /// </returns>
        public static bool TryCreate(ushort messageId, out Message message)
        {
            var type = (Type)null;
            if (!s_messageDictionary.TryGetValue(messageId, out type))
            {
